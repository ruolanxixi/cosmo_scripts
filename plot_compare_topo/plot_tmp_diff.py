...
cs0 = axs0.pcolormesh(rlon, rlat, tmp_merit_DJF, cmap='RdYlBu_r', norm=divnorm, shading="auto")
cs1 = axs1.pcolormesh(rlon, rlat, tmp_merit_era_DJF, cmap='RdYlBu_r', vmin=-5, vmax=5, shading="auto")
cs2 = axs2.pcolormesh(rlon, rlat, tmp_ctrl_era_DJF, cmap='RdYlBu_r', vmin=-5, vmax=5, shading="auto")

cs3 = axs3.pcolormesh(rlon, rlat, tmp_merit_MAM, cmap='RdYlBu_r', norm=divnorm, shading="auto")
cs4 = axs4.pcolormesh(rlon, rlat, tmp_merit_era_MAM, cmap='RdYlBu_r', vmin=-5, vmax=5, shading="auto")
cs5 = axs5.pcolormesh(rlon, rlat, tmp_ctrl_era_MAM, cmap='RdYlBu_r', vmin=-5, vmax=5, shading="auto")

cs6 = axs6.pcolormesh(rlon, rlat, tmp_merit_JJA, cmap='RdYlBu_r', norm=divnorm, shading="auto")
cs7 = axs7.pcolormesh(rlon, rlat, tmp_merit_era_JJA, cmap='RdYlBu_r', vmin=-5, vmax=5, shading="auto")
cs8 = axs8.pcolormesh(rlon, rlat, tmp_ctrl_era_JJA, cmap='RdYlBu_r', vmin=-5, vmax=5, shading="auto")

cs9 = axs9.pcolormesh(rlon, rlat, tmp_merit_SON, cmap='RdYlBu_r', norm=divnorm, shading="auto")
cs10 = axs10.pcolormesh(rlon, rlat, tmp_merit_era_SON, cmap='RdYlBu_r', vmin=-5, vmax=5, shading="auto")
cs11 = axs11.pcolormesh(rlon, rlat, tmp_ctrl_era_SON, cmap='RdYlBu_r', vmin=-5, vmax=5, shading="auto")

# add wind component
axs0.set_title("MERIT", fontweight='bold', pad=10)
axs1.set_title("MERIT - ERA5", fontweight='bold', pad=10)
axs2.set_title("GLOBE - ERA5", fontweight='bold', pad=10)
...
cax = fig.add_axes([axs9.get_position().x0 + 0.006, axs9.get_position().y0 - 0.04, axs9.get_position().width*0.95, 0.01])
cb1 = fig.colorbar(cs9, cax=cax, orientation='horizontal')
cax = fig.add_axes([axs10.get_position().x0 + 0.02, axs10.get_position().y0 - 0.04, axs10.get_position().width*2, 0.01])
cb2 = fig.colorbar(cs10, cax=cax, orientation='horizontal')
...
fig.savefig('figure_tmp_diff.png', dpi=300)
