...
# import data
#
path = "/Users/kaktus/Documents/ETH/BECCY/myscripts/data/extpar/"
file1 = 'extpar_12km_878x590.nc'
...
cs0 = axs0.contourf(lon, lat, elev_ctrl, transform=ccrs.PlateCarree(), levels=14, cmap=cmap1, vmin=0, vmax=7000)
axs0.contour(lon, lat, elev_ctrl, cs0.levels, colors='k', linewidths=.3)
cs1 = axs1.contourf(lon, lat, elev_topo1, transform=ccrs.PlateCarree(), levels=14, cmap=cmap1, vmin=0, vmax=7000)
axs1.contour(lon, lat, elev_topo1, cs1.levels, colors='k', linewidths=.3)
cs2 = axs2.contourf(lon, lat, elev_diff, transform=ccrs.PlateCarree(), levels=17, cmap=palette, vmin=0, vmax=4500)
axs2.contour(lon, lat, elev_diff, cs2.levels, colors='k', linewidths=.3)
...
fig.savefig('figure_topo.png', dpi=300)
