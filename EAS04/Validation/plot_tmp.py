...
year = '2001-2005'
mdpath = "/scratch/snx3000/rxiang/data/cosmo/EAS04_ctrl/szn/T_2M/"
...
for seas in range(len(seasons)):
    season = seasons[seas]
    filename = f'APHRO.2001-2005.025.{season}.remap.04.nc'
...
# -------------------------
# add title
axs[0, 0].set_title("COSMO", fontsize=14, fontweight='bold', pad=10)
axs[0, 1].set_title("COSMO-ERA5", fontsize=14, fontweight='bold', pad=10)
axs[0, 2].set_title("COSMO-CRU", fontsize=14, fontweight='bold', pad=10)
axs[0, 3].set_title("COSMO-APHRO", fontsize=14, fontweight='bold', pad=10)
