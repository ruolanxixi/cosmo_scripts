...
class Plot_Cross(UserDict):
    ...
    def add_terrain(self, xyline, level=57):
        # FIXME
        f = xr.open_dataset('/project/pr133/rxiang/data/cross/terrain.topo2.zonmean.04.nc')
    ...
    def add_profile(self, var, varname, w_factor=None, colorbar=True):
        ...
        self.ax.text(0, 1.02, 'Envelope topography', ha='left', va='center', transform=self.ax.transAxes,
                fontsize=10)
...
if __name__ == '__main__':
    data_d = xr.open_dataset('/project/pr133/rxiang/data/cosmo/EAS04_topo2/szn/DIAB_SUM/2001-2005.DIAB_SUM.JJA.zonmean.nc')
    ...
    data.save_fig('/project/pr133/rxiang/figure/EAS04/analysis/diabatic/topo2', format='png', dpi=550, transparent=True)
    plt.show()
    # data.save_fig()
