...
for s in range(len(sims)):
    ...
    perct = np.percentile(cpm[24:55], 97.5, axis=0)
...
fig.suptitle('Heavy daily precipitation May to Sep (97.5th percentile)', fontsize=16, fontweight='bold')
...
fig.savefig(plotpath + 'p97.5d.png', dpi=500)
plt.close(fig)
