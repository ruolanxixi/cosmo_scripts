...
# plot difference
cs[0, 2] = axs[0, 2].pcolormesh(rlon, rlat, all_vimd_smr_sms[1] - all_vimd_smr_sms[0], cmap=cmap2, norm=norm2,
                                shading="auto")
...
cs[1, 2] = axs[1, 2].pcolormesh(rlon, rlat, all_vmfc_smr_sms[1] - all_vmfc_smr_sms[0], cmap=cmap2, norm=norm2,
                                shading="auto")
...
fig.savefig(plotpath + 'extreme4.png', dpi=500)
plt.close(fig)
