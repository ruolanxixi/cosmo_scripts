...
q[2] = axs[2].quiver(rlon[::30], rlat[::30], (all_u[1] - all_u[0])[::30, ::30],
                                                 (all_v[1] - all_v[0])[::30, ::30], color='black', scale=25)
axs[2].quiverkey(q[2], 0.88, 1.04, 1, r'$1\ \frac{m}{s}$', labelpos='E', labelsep=0.08, transform=axs[2].transAxes,
                    fontproperties={'size': 11})
axs[2].text(0, 1.02, 'Envelope - Control', ha='left', va='bottom', transform=axs[2].transAxes, fontsize=14)
...
axs[3].text(0, 1.02, 'Envelope - Control', ha='left', va='bottom', transform=axs[3].transAxes, fontsize=14)
