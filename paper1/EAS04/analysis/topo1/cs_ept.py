...
for i in range(nrow):
    ...
    for j in range(ncol):
        ...
        axs[i, j].fill_between(np.arange(terrain.shape[0]), terrain / 1000, color='black')
...
clabel2 = axs[0, 0].clabel(ct[0, 0], inline=True, fontsize=12, manual=[(150, 12.5), (210, 8), (290, 8), (400, 8), (500, 9)], use_clabeltext=True)
for l in clabel2:
    l.set_rotation(0)

clabel2 = axs[0, 1].clabel(ct[0, 1], inline=True, fontsize=12, manual=[(10, 12), (50, 12), (95, 9), (350, 7), (460, 8), (500, 8)], use_clabeltext=True)
for l in clabel2:
    l.set_rotation(0)
