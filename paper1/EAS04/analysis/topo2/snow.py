...
for j in range(ncol):
    axs[0, j].text(0.06, -0.02, '95°E', ha='center', va='top', transform=axs[0, j].transAxes, fontsize=13)
    axs[0, j].text(0.46, -0.02, '100°E', ha='center', va='top', transform=axs[0, j].transAxes, fontsize=13)
    axs[0, j].text(0.86, -0.02, '105°E', ha='center', va='top', transform=axs[0, j].transAxes, fontsize=13)
...
fig.savefig(plotpath + 'snow.png', dpi=500)
