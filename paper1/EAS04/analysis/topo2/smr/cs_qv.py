...
class Plot_Cross(UserDict):
    ...
    def add_profile(self, var, varname, w_factor=None, colorbar=True):
        ...
        lon_value = wrf.interp2dxy(lon_cross, self.xyline)[1]
        ...
        for i in range(len(lons)):
            ii = lons[i]
            id = self.get_closed_id(lon_value, ii)
        ...
        self.ax.set_xticklabels([u'90\N{DEGREE SIGN}E', u'95\N{DEGREE SIGN}E', u'100\N{DEGREE SIGN}E',
                                 u'105\N{DEGREE SIGN}E', u'110\N{DEGREE SIGN}E'])
...
if __name__ == '__main__':
    ...
    data_d2 = xr.open_dataset(
        '/project/pr133/rxiang/data/cosmo/EAS04_ctrl/szn/QV/2001-2005.QV.JJA.nc')
    ...
    data = Plot_Cross(rlon_start=-25.2, rlon_end=-2.88, rlat_start=-0.07, rlat_end=0.69, zmax=14)
    ...
    # data.save_fig('/project/pr133/rxiang/figure/paper1/results/TENV/qv_ctrl_sm.png', format='png', dpi=550,
                   # transparent=True)
    plt.show()
    # data.save_fig()
