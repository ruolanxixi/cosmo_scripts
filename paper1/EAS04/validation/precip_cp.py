...
mdpath04 = "/project/pr133/rxiang/data/cosmo/EAS04_ctrl/szn"
mdpath = "/project/pr133/rxiang/data/cosmo/EAS11_ctrl/szn"
erapath = "/project/pr133/rxiang/data/era5/pr"
imergpath = "/project/pr133/rxiang/data/obs/pr/IMERG"
...
for s in range(len(seasons)):
    ...
    # COSMO 4.4 km
    precip['CPM'][season] = {}
    data = xr.open_dataset(f'{mdpath04}/TOT_PREC/2001-2005.TOT_PREC.{season}.nc')
    ...
    # ERA5
    precip['ERA5'][season] = {}
    data = xr.open_dataset(f'{erapath}/szn/era5.mo.2001-2005.{season}.nc')
    ...
    # --
    data = xr.open_dataset(f'{erapath}/remap/era5.mo.2001-2005.{season}.remap.04.nc')
    pr = data['tp'].values[0, :, :] * 1000
    ...
    precip['CPM'][season]['BIAS']['ERA5'] = np.nanmean(precip['CPM'][season]['precip'][87:-10, 160:-10] - pr[87:-10, 160:-10])
    data = xr.open_dataset(f'{erapath}/remap/era5.mo.2001-2005.{season}.remap.nc')
    pr = data['tp'].values[0, :, :] * 1000
    ...
    # IMERG
    precip['IMERG'][season] = {}
    data = xr.open_dataset(f'{imergpath}/szn/IMERG.2001-2005.corr.{season}.nc')
    ...
    # --
    data = xr.open_dataset(f'{imergpath}/remap/IMERG.2001-2005.corr.{season}.remap.04.nc')
    pr = data['precipitation_corr'].values[0, :, :]
    ...
    precip['CPM'][season]['BIAS']['IMERG'] = np.nanmean(precip['CPM'][season]['precip'][10:-10, 10:-10] - pr[10:-10, 10:-10])
    data = xr.open_dataset(f'{imergpath}/remap/IMERG.2001-2005.corr.{season}.remap.nc')
    pr = data['precipitation_corr'].values[0, :, :]
    ...
    precip['LSM'][season]['BIAS']['IMERG'] = np.nanmean(precip['LSM'][season]['precip'][241:471, 112:346] - pr[241:471, 112:346])
...
# fig.savefig(plotpath + 'precip_cp.png', dpi=500)
plt.close(fig)
