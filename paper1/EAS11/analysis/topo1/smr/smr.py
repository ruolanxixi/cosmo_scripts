...
for j in range(ncol):
    axs[4, j].text(0.12, -0.02, '80°E', ha='center', va='top', transform=axs[4, j].transAxes, fontsize=13)
    axs[4, j].text(0.32, -0.02, '100°E', ha='center', va='top', transform=axs[4, j].transAxes, fontsize=13)
    axs[4, j].text(0.52, -0.02, '120°E', ha='center', va='top', transform=axs[4, j].transAxes, fontsize=13)
    axs[4, j].text(0.72, -0.02, '140°E', ha='center', va='top', transform=axs[4, j].transAxes, fontsize=13)
    axs[4, j].text(0.92, -0.02, '160°E', ha='center', va='top', transform=axs[4, j].transAxes, fontsize=13)
