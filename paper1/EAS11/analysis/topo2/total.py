...
ncol = 3  # edit here
nrow = 3
axs, cs, ct, topo, topo2 = np.empty(shape=(nrow, ncol), dtype='object'), np.empty(shape=(nrow, ncol), dtype='object'), \
...
axs[1, 0].text(-0.16, 0.55, 'TENV', ha='center', va='center', rotation='vertical',
               transform=axs[1, 0].transAxes, fontsize=13, fontweight='bold')
axs[2, 0].text(-0.16, 0.55, 'TENV - CTRL', ha='center', va='center', rotation='vertical',
...
fig.show()
plotpath = "/project/pr133/rxiang/figure/analysis/EAS11/topo2/"
