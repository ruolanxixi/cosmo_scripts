...
rad_red_ext = 300  # 300  # extend reduction radius at flat, amplitude maximum [km]
alpha_0, alpha_1 = -135.0, 45.0  # measured anti-clockwise from East [degree]
fac_amp = 0.9  # 0.75  # amplitude of terrain reduction
...
path_out = "/project/pr133/rxiang/data/MERIT/MERIT_tiles_red/"
