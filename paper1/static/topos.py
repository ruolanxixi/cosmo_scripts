...
left, bottom, right, top = 0.06, 0.07, 0.90, 0.94
...
cs[0, 0] = axs[0, 0].pcolormesh(rlon, rlat, ctrl, cmap=cmap_ter, norm=norm, shading="auto", transform=rot_pole_crs)
cs[0, 1] = axs[0, 1].pcolormesh(rlon, rlat, topo1, cmap=cmap_ter, norm=norm, shading="auto", transform=rot_pole_crs)
cs[0, 2] = axs[0, 2].pcolormesh(rlon, rlat, topo2, cmap=cmap_ter, norm=norm, shading="auto", transform=rot_pole_crs)
...
for j in range(ncol):
    title = sims[j]
    axs[0, j].set_title(f'{title}', pad=5, fontsize=18, loc='left')

for i in range(nrow):
    axs[i, 0].text(-0.01, 0.86, '35°N', ha='right', va='center', transform=axs[i, 0].transAxes, fontsize=18)
    axs[i, 0].text(-0.01, 0.665, '30°N', ha='right', va='center', transform=axs[i, 0].transAxes, fontsize=18)
    axs[i, 0].text(-0.01, 0.47, '25°N', ha='right', va='center', transform=axs[i, 0].transAxes, fontsize=18)
    axs[i, 0].text(-0.01, 0.275, '20°N', ha='right', va='center', transform=axs[i, 0].transAxes, fontsize=18)
    axs[i, 0].text(-0.01, 0.08, '15°N', ha='right', va='center', transform=axs[i, 0].transAxes, fontsize=18)

for j in range(ncol):
    axs[0, j].text(0.04, -0.02, '90°E', ha='center', va='top', transform=axs[0, j].transAxes, fontsize=18)
    axs[0, j].text(0.46, -0.02, '100°E', ha='center', va='top', transform=axs[0, j].transAxes, fontsize=18)
    axs[0, j].text(0.86, -0.02, '110°E', ha='center', va='top', transform=axs[0, j].transAxes, fontsize=18)
