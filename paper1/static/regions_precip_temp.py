...
# Output directory for region masks
path_out = "/scratch/snx3000/csteger/region_masks/"
...
for i in prec_prod.keys():
    ...
    # Load region masks
    ds = xr.open_dataset(path_out + i + "_region_masks.nc")
...
topo = {}
# -----------------------------------------------------------------------------
ds = xr.open_dataset("/scratch/snx3000/csteger/Temp/"
