...
cs = ax.pcolormesh(rlon, rlat, all_smr[1] - all_smr[0], cmap=cmap, clim=(-10, 10), shading="auto")
q = ax.quiver(rlon[::30], rlat[::30], all_u[1][::30, ::30]-all_u[0][::30, ::30],
                           all_v[1][::30, ::30]-all_v[0][::30, ::30], color='black', scale=50)
...
# save figure
plotpath = "/project/pr133/rxiang/figure/EAS11/analysis/monsoon/topo1/"
fig.savefig(plotpath + 'smw.png', dpi=300)
plt.close(fig)
