...
for s in range(len(sims)):
    ...
    path = f'/project/pr133/rxiang/data/cosmo/EAS11_{sim}/monsoon/TWATFLXU/smr'
    ...
    path = f'/project/pr133/rxiang/data/cosmo/EAS11_{sim}/monsoon/TWATFLXV/smr'
...
for i in range(2):
    ...
    q[i, 0] = axs[i, 0].quiver(rlon[::40], rlat[::40], all_u_smr[0][::40, ::40],
                  all_v_smr[0][::40, ::40], color='black', scale=5000)

qk[0, 0] = axs[0, 0].quiverkey(q[0, 0], 0.895, 1.06, 200, r'$200$', labelpos='E', transform=axs[0, 0].transAxes,
                      fontproperties={'size': 12})
# plot difference
axs[2, 0] = plotcosmo(axs[2, 0])
cs[2, 0] = axs[2, 0].pcolormesh(rlon, rlat, all_ws_smr[1] - all_ws_smr[0], cmap=cmap2, clim=(-100, 100), shading="auto")
...
q[2, 0] = axs[2, 0].quiver(rlon[::40], rlat[::40], all_u_smr[1][::40, ::40]-all_u_smr[0][::40, ::40],
                  all_v_smr[1][::40, ::40]-all_v_smr[0][::40, ::40], color='black', scale=1000)
