...
gs1 = gridspec.GridSpec(3, 2, left=0.05, bottom=0.03, right=0.6,
                        top=0.97, hspace=0.1, wspace=0.08,
                        width_ratios=[1, 1], height_ratios=[1, 1, 1])
gs2 = gridspec.GridSpec(3, 1, left=0.66, bottom=0.03, right=0.925,
                        top=0.97, hspace=0.1, wspace=0.08)
ncol = 3  # edit here
nrow = 3
...
for j in range(ncol):
    axs[2, j].text(0.12, -0.02, '80°E', ha='center', va='top', transform=axs[2, j].transAxes, fontsize=13)
    axs[2, j].text(0.32, -0.02, '100°E', ha='center', va='top', transform=axs[2, j].transAxes, fontsize=13)
    axs[2, j].text(0.52, -0.02, '120°E', ha='center', va='top', transform=axs[2, j].transAxes, fontsize=13)
    axs[2, j].text(0.72, -0.02, '140°E', ha='center', va='top', transform=axs[2, j].transAxes, fontsize=13)
    axs[2, j].text(0.92, -0.02, '160°E', ha='center', va='top', transform=axs[2, j].transAxes, fontsize=13)

plt.show()
plotpath = "/project/pr133/rxiang/figure/paper1/validation/LSM/"
fig.savefig(plotpath + 'vali2.png', dpi=500)
plt.close(fig)
