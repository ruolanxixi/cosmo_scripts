...
prec_diff = (prec_ctrl+0.0000000000001 - prec_topo1)/(prec_ctrl+0.0000000000001)*100
...
cs2 = axs2.contourf(lon, lat, prec_diff, transform=ccrs.PlateCarree(), levels=np.linspace(-50, 50, 21), cmap='RdYlBu', vmin=-50, vmax=50)
