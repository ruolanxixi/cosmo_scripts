...
gs = gridspec.GridSpec(2, 2, left=0.07, bottom=0.1, right=0.9,
                       top=0.95, hspace=0.12, wspace=0.18,
...
plt.pcolormesh(lon0, lat0, elev_ctrl, shading="auto", cmap=cmap, norm=norm)
...
cs = plt.pcolormesh(lon0, lat0, elev_topo1, shading="auto", cmap=cmap, norm=norm)
ax.add_feature(cfeature.OCEAN, edgecolor='k')
ax.add_feature(cfeature.COASTLINE)
ax.add_feature(cfeature.BORDERS, linestyle=':')
ax.add_feature(cfeature.RIVERS, alpha=0.5)
...
cs = plt.pcolormesh(lon0, lat0, elev_diff1, shading="auto", cmap=cmap, norm=norm)
ax.add_feature(cfeature.OCEAN, edgecolor='k')
ax.add_feature(cfeature.COASTLINE)
ax.add_feature(cfeature.BORDERS, linestyle=':')
ax.set_aspect("auto")
