...
cax = fig.add_axes([axs[0, 0].get_position().x0, axs[0, 0].get_position().y0-0.12, axs[0, 1].get_position().x1-axs[0, 0].get_position().x0, 0.04])
cbar = fig.colorbar(cs[0, 1], cax=cax, orientation='horizontal', extend='max', ticks=ticks)
