...
pr_ctrl = xr.open_dataset(f'{ctrlpath}/{mdvname}/{year}_{mdvname}_{season}.nc')[mdvname].values[0, :, :]
pr_lgm = xr.open_dataset(f'{topo1path}/{mdvname}/{year}_{mdvname}_{season}.nc')[mdvname].values[0, :, :]
...
cb2.set_label('mm/day', fontsize=11)
