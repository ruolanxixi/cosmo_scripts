...
pr['PD']['01']['precip'] = xr.open_dataset(f'{erapath}/era5.mo.1970-1995.mon.remap.echam5.nc')['tp'].values[0, :, :]*1000
pr['PD']['07']['precip'] = xr.open_dataset(f'{erapath}/era5.mo.1970-1995.mon.remap.echam5.nc')['tp'].values[6, :, :]*1000
# %%
...
for mon in ['01', '07']:
    ...
    for i in range(4):
        ...
        axs[0, i].stock_img()
        axs[0, i].gridlines()
        cs[0, i] = axs[0, i].pcolormesh(lon, lat, pr[sim][mon]['precip'], cmap=cmap1, norm=norm1, shading="auto",
    ...
    for i in range(3):
        ...
        axs[1, i + 1].stock_img()
        axs[1, i + 1].gridlines()
        cs[1, i + 1] = axs[1, i + 1].pcolormesh(lon, lat, pr[sim][mon]['precip'] - pr['PI'][mon]['precip'], cmap=cmap2,
    ...
    fig.savefig(plotpath + 'precip' + f'{mon}.era5.1970-1995.png', dpi=500)
    plt.close(fig)
