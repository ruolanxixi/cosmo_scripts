...
for s in range(len(sims)):
    ...
    for mon in ['01', '07']:
        ...
        rh2 = mpcalc.relative_humidity_from_dewpoint(t2m, dew2) * 100
        relhum2[sim][mon]['relhum2'] = rh2

relhum2['PD']['01']['relhum2'] = mpcalc.relative_humidity_from_dewpoint(xr.open_dataset(f'{erapath}/era5.mo.1970-1995.mon.remap.echam5.nc')['t2m'].values[0, :, :] * units.kelvin,
                                 xr.open_dataset(f'{erapath}/era5.mo.1970-1995.mon.remap.echam5.nc')['d2m'].values[0, :, :] * units.kelvin) * 100
relhum2['PD']['07']['relhum2'] = mpcalc.relative_humidity_from_dewpoint(xr.open_dataset(f'{erapath}/era5.mo.1970-1995.mon.remap.echam5.nc')['t2m'].values[6, :, :] * units.kelvin,
                                 xr.open_dataset(f'{erapath}/era5.mo.1970-1995.mon.remap.echam5.nc')['d2m'].values[6, :, :] * units.kelvin) * 100
...
for mon in ['01', '07']:
    ...
    fig.savefig(plotpath + 'relhum2' + f'{mon}.era5.1970-1995.png', dpi=500)
    plt.close(fig)
